...
This is a repository for my Neovim configuration, based on [hendrikmi's neovim-kickstarter-config](https://github.com/hendrikmi/neovim-kickstart-config/tree/main) and [kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim).

To use, clone this repo, and copy its contents to `~/.config/nvim`

## Included Plugins

- nvim-treesitter - builds syntax tree
- nvim-neo-tree/neo-tree.nvim - explorer
- nvim-telescope/telescope.nvim - fuzzy finder
- nvim-lualine/lualine.nvim - status line at bottom
- akinso/bufferline.nvim - tabs at top
